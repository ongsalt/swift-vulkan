...
def enum_conversion(c_enum: str, swift_enum: str, isU64: bool = False) -> Conversion:
    ty = "UInt64" if isU64 else "UInt32"
    return Conversion(
...
def option_set_bit_conversion(c_enum: str, option_set: str, isU64: bool = False) -> Conversion:
    ty = "UInt64" if isU64 else "UInt32"
    return Conversion(
